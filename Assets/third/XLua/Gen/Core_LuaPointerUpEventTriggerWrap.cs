...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaPointerUpEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaPointerUpEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaPointerUpEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaPointerUpEventTrigger constructor!");
        ...
        static int _m_OnPointerUp(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaPointerUpEventTrigger gen_to_be_invoked = (Core.LuaPointerUpEventTrigger)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnPointerUp( _pointerEventData );
