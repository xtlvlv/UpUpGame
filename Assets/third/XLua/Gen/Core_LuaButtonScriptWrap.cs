...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaButtonScriptWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaButtonScript);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaButtonScript();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaButtonScript constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaButtonScript gen_to_be_invoked = (Core.LuaButtonScript)translator.FastGetCSObj(L, 1);
