...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaButtonEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaButtonEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaButtonEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaButtonEventTrigger constructor!");
        ...
        static int _m_OnClick(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaButtonEventTrigger gen_to_be_invoked = (Core.LuaButtonEventTrigger)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_eventItemArray(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaButtonEventTrigger gen_to_be_invoked = (Core.LuaButtonEventTrigger)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.eventItemArray = (Core.LuaButtonEventItem[])translator.GetObject(L, 2, typeof(Core.LuaButtonEventItem[]));
