...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaDropEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaDropEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaDropEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaDropEventTrigger constructor!");
        ...
        static int _m_OnDrop(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaDropEventTrigger gen_to_be_invoked = (Core.LuaDropEventTrigger)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnDrop( _pointerEventData );
