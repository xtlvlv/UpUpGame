...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaPointerDownEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaPointerDownEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaPointerDownEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaPointerDownEventTrigger constructor!");
        ...
        static int _m_OnPointerDown(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaPointerDownEventTrigger gen_to_be_invoked = (Core.LuaPointerDownEventTrigger)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnPointerDown( _pointerEventData );
