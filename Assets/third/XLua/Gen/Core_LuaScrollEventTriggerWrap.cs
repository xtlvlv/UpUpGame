...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaScrollEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaScrollEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaScrollEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaScrollEventTrigger constructor!");
        ...
        static int _m_OnScroll(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaScrollEventTrigger gen_to_be_invoked = (Core.LuaScrollEventTrigger)translator.FastGetCSObj(L, 1);
