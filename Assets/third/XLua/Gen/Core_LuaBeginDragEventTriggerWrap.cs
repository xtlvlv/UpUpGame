...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaBeginDragEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaBeginDragEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaBeginDragEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaBeginDragEventTrigger constructor!");
        ...
        static int _m_OnBeginDrag(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaBeginDragEventTrigger gen_to_be_invoked = (Core.LuaBeginDragEventTrigger)translator.FastGetCSObj(L, 1);
