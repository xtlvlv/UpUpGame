...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaPointerExitEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaPointerExitEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaPointerExitEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaPointerExitEventTrigger constructor!");
        ...
        static int _m_OnPointerExit(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaPointerExitEventTrigger gen_to_be_invoked = (Core.LuaPointerExitEventTrigger)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnPointerExit( _pointerEventData );
