...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaPointerEnterEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaPointerEnterEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaPointerEnterEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaPointerEnterEventTrigger constructor!");
        ...
        static int _m_OnPointerEnter(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaPointerEnterEventTrigger gen_to_be_invoked = (Core.LuaPointerEnterEventTrigger)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnPointerEnter( _pointerEventData );
