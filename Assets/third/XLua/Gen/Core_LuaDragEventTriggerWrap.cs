...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreLuaDragEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.LuaDragEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Core.LuaDragEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.LuaDragEventTrigger constructor!");
        ...
        static int _m_OnDrag(RealStatePtr L)
        {
		    try {
                ...
                Core.LuaDragEventTrigger gen_to_be_invoked = (Core.LuaDragEventTrigger)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnDrag( _pointerEventData );
