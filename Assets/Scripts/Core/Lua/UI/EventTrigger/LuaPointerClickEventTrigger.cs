...
[System.Serializable]
public class LuaPointerClickEventItem
{
    public string eventName = "OnPointerClick";
    public System.Action<PointerEventData> action;
    public string parameter;
}

[LuaCallCSharp]
public class LuaPointerClickEventTrigger : MonoBehaviour, IPointerClickHandler
{
