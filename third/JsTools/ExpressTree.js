...
var tokens = new Lexer('(1+2)*(5-3)').parse();  // 1.词义解析
console.log(tokens);
var expression = new ExpressionTreeConstructor(tokens);
var root = expression.build_tree(); // 2.构建树
console.log(root.eval())            // 3.执行计算
console.log(JSON.stringify(root))
console.log(root.eval())
console.log(root.eval())
